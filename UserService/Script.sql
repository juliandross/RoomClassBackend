...
INSERT INTO user_user (email, first_name, last_name, is_active, is_staff, rol, password)
VALUES ('profesor1@ejemplo.com', 'Ana', 'García', TRUE, FALSE, 'DOCENTE', '1234');

INSERT INTO user_user (email, first_name, last_name, is_active, is_staff, rol, password)
VALUES ('profesor2@ejemplo.com', 'Luis', 'Martínez', TRUE, FALSE, 'DOCENTE', '1234');
